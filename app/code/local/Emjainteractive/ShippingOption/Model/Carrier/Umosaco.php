 ...
 * @copyright  Copyright (c) 2014 EmJa Interactive, LLC. (http://www.emjainteractive.com)
 * @license    http://www.emjainteractive.com/LICENSE.txt
 */

class Emjainteractive_ShippingOption_Model_Carrier_Umosaco 
    extends Mage_Shipping_Model_Carrier_Abstract
    implements Mage_Shipping_Model_Carrier_Interface
{
	protected $_code = 'umosaco';
    ...
    {
        return array('umosaco' => $this->getConfigData('name'));
    }
}