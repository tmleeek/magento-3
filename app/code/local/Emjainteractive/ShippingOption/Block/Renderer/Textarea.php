...
class Emjainteractive_ShippingOption_Block_Renderer_Textarea extends Emjainteractive_ShippingOption_Block_Renderer_Abstract
{
    ...
    protected function _renderElement()
    {
        ...
        if ($req) {
            $html = '<textarea class="input-text required-entry" name="' . $this->_getElementName() . '" id="' . $this->_getElementId() . '">' . $val . '</textarea>';
        } else {
            $html = '<textarea name="' . $this->_getElementName() . '" id="' . $this->_getElementId() . '">' . $val . '</textarea>';
        }
        return $html;
    }
}
